...
class VOCAnnotation(object):
    def __init__(self, year, mode, data_path, class_names_path):
        ...
        :param data_path: 数据存放目录  /Users/lx/segment_data 只需到VOCdevkit目录上一层
...
# voc = VOCAnnotation(2007, 'train', '/Users/lx/segment_data', './data/voc_classes.txt')
# voc = VOCAnnotation(2007, 'val', '/Users/lx/segment_data', './data/voc_classes.txt')
#
